...
void read_data(int _num,byte* _buf)
{
  ...
  case 3: 
    ...
    for(int a=0;a<_num;a++)
    {
      egg_hum[a]=-6.0 + 125.0 * (float)((float)_bufin[a]/65535.0);
#ifdef _DEBUG
...
void setup() 
{
  ...
  //rtc.setDate(23, 6, 8, 0, 14);  //day, weekday, month, century(1=1900, 0=2000), year(0-99)
  //rtc.setTime(13, 52, 30);  //hr, min, sec
