...
void read_data(int _num,byte* _buf)
{
  ...
  case 1: 
    ...
    }
    {
      float gravity[3];
      float q[4]={
        egg_mpu[3],egg_mpu[4],egg_mpu[5],egg_mpu[6]
      };
      //------------
      ...
      egg_mpu_ypr[0] = atan2(2*q[1]*q[2] - 2*q[0]*q[3], 2*q[0]*q[0] + 2*q[1]*q[1] - 1);
      ...
      //-------------
      egg_mpu_acc[0]=egg_mpu[0];
      egg_mpu_acc[1]=egg_mpu[1];
      egg_mpu_acc[2]=egg_mpu[2];
    }
    break;
  case 2: 
#ifdef _DEBUG
